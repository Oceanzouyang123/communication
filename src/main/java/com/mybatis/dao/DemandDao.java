...
public class DemandDao {
	...
	public List<TableWorkbook> QueryTableWorkbook(String sqlwhere){
		String sql = "select tablenamecn,tablenamepy,columnnamecn,columnnamepy from tablewordbook "+sqlwhere;
		ResultSet rs = sqlHelper.executeQuery(sql);
	...
	public List<TableWorkbook> QueryDistictnWorkbook(String sqlwhere){
		String sql = "select DISTINCT tablenamecn,tablenamepy from tablewordbook "+sqlwhere;
	...
	//查询明细表
	public String QueryDemandwhere(String sqlwhere) throws SQLException{
	...
	//根据id查询明细表
	public String QueryDemandById(String sqlwhere) throws SQLException{
		StringBuffer sb = new StringBuffer();
		String sql = "select * from "+sqlwhere;
		ResultSet rs = sqlHelper.executeQuery(sql);
		ResultSetMetaData ramd = rs.getMetaData();
	...
	//修改表结构
	public void alterDemandTable(String sqlwhere){
	...
	//根据id更新临时表单数据
	public int updateDemandById(String sqlwhere){
	...
	public int InsertWorkbook(String sql){
		sql = "insert into tablewordbook (tablenamecn,tablenamepy,columnnamecn,columnnamepy) values"+sql;
		//System.out.println("sql=="+sql);
